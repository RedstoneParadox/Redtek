...
public class TileEntityHeatVent extends TileEntityThermalBase implements ITickable, IThermalBlocks{
    ...
    //List of old to search. Does not require changing so it is kept immutable.
    ...
    //The most basic method of permanently and mercilessly eradicating old from existence.
